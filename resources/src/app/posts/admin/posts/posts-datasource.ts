 ...
 */
export class PostsDataSource extends DataSource<PostsItem> {
  data: PostsItem[] = EXAMPLE_DATA;
   ...
   */
  private getPagedData(data: PostsItem[]): PostsItem[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: PostsItem[]): PostsItem[] {
